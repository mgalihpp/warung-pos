...
import { useDeleteProduct } from "../hooks/use-produk-actions"
import type { ProdukDetailData } from "../server-data-detail"

type ProdukDetailPageProps = {
  data: NonNullable<ProdukDetailData>
}

function getStatus(product: ProdukDetailPageProps["data"]["product"]) {
...
export function ProdukDetailPage({ data }: ProdukDetailPageProps) {
    ...
    <div className="flex min-w-0 flex-col gap-4 p-4 pb-24 lg:gap-6 lg:p-6">
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Lihat informasi lengkap, performa, dan stok produk
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          >
            ...
            {isDuplicating ? "Menduplikasi..." : "Duplikat Produk"}
          </Button>
          <Button
            type="button"
            variant="outline"
      ...
      <div className="flex min-w-0 flex-col gap-4 lg:gap-6">
          ...
          <section className="rounded-xl border bg-card p-4 shadow-sm lg:p-5">
            <h2 className="mb-4 text-sm font-semibold">Informasi Produk</h2>
            <div className="grid gap-5 sm:grid-cols-[220px_1fr] lg:grid-cols-[260px_1fr]">
              ...
              <dl className="divide-y divide-border/60 text-sm">
                <InfoRow label="Nama Produk" value={product.name} />
          ...
          <div className="grid gap-4 lg:grid-cols-2 lg:gap-6">
            ...
            <section className="rounded-xl border bg-card p-4 shadow-sm lg:p-5">
              <h2 className="mb-3 text-sm font-semibold">Deskripsi Produk</h2>
              {product.description ? (
          ...
          <section className="rounded-xl border bg-card p-4 shadow-sm lg:p-5">
            ...
            {activities.length === 0 ? (
              <div className="rounded-lg border border-dashed p-6 text-center text-xs text-muted-foreground">
                Belum ada aktivitas pada produk ini.
              </div>
            ) : (
