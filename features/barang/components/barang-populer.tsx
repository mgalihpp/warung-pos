...
import type { BarangPopularItem } from "../types"

type BarangPopulerProps = {
  products: BarangPopularItem[]
}

export function BarangPopuler({ products }: BarangPopulerProps) {
  return (
    <div className="rounded-xl border bg-card p-4 shadow-sm">
      <div className="mb-3 flex items-center justify-between">
        <h3 className="text-sm font-semibold">Barang Populer</h3>
        <Link
          href="/admin/barang"
