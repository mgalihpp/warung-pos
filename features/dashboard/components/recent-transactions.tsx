        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b text-left text-xs text-muted-foreground">
              <th className="pr-3 pb-2.5 font-medium">No</th>
              <th className="pr-3 pb-2.5 font-medium">Waktu</th>
              <th className="pr-3 pb-2.5 font-medium">Kasir</th>
              <th className="pr-3 pb-2.5 font-medium">Item</th>
              <th className="pr-3 pb-2.5 text-right font-medium">Total</th>
