...
import { useUpdateTransaction } from "../hooks/use-transaksi-actions"
...
function reverseMapPaymentMethod(
  uiLabel: string
): "CASH" | "QRIS_MANUAL" | "MANUAL_TRANSFER" {
  switch (uiLabel) {
    case "Tunai":
      return "CASH"
    case "QRIS":
                ...
                >
                  ...
                  <div className="flex items-center justify-between gap-1.5 sm:justify-start">
                    ...
                    <Input
                      ...
                      value={item.quantity}
                      onChange={(e) =>
                        setQuantity(index, Number(e.target.value) || 1)
                      }
          ...
          <div className="rounded-2xl border bg-card p-4 shadow-sm lg:rounded-xl lg:p-5">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex justify-between border-t border-border/50 pt-3 text-base font-bold">
                <span>Total</span>
                <span className="text-right break-words text-primary">
                  {formatRupiah(subtotal)}
                </span>
              </div>
              <div className="flex justify-between text-muted-foreground">
              ...
              <div className="flex justify-between text-muted-foreground">
                <span>Kembalian</span>
                <span
                  className={`text-right font-medium break-words ${
