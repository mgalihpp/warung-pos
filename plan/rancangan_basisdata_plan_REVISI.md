...
> - **Tidak menggunakan barcode scanner** — pencarian barang dilakukan secara manual via search bar
> - **Tidak menggunakan mesin struk/printer** — struk digital saja
> - **Tidak ada integrasi payment gateway pihak ketiga** — metode pembayaran yang didukung: **Cash**, **QRIS**, dan **Transfer Bank**
...
| `paymentMethod` | `String` | `@default("cash")` | Metode pembayaran: `cash`, `qris`, `transfer` |
