...
export const productBaseSchema = {
  ...
  minStock: z.coerce.number().int("Stok minimum harus bilangan bulat").min(0, "Stok minimum tidak boleh negatif"),
...
export const createProductSchema = z.object({
  ...
  minStock: z.number().int("Stok minimum harus bilangan bulat").min(0, "Stok minimum tidak boleh negatif"),
